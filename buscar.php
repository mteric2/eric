...
if(isset($_GET['query'])) {
    ...
    $sql = "SELECT * FROM formulario2 WHERE nombre LIKE '%$query%' OR apellido LIKE '%$query%' OR id LIKE '%$query%'";
    $result = mysqli_query($conex, $sql);
    
    if(mysqli_num_rows($result) > 0) {
        // Mostrar resultados
        echo "<section>";
        echo '<center> <br><h1>Resultados de la búsqueda:</h1><br></center>';
     echo"<p>REGRESAR</p><a href='admin.php'><i class='fa-solid fa-angles-left fa-lg' style='color: #005eff;'></i></button></a>";
        echo "<table>";
        echo "<tr><th> ID</th><th>DEVISE</th><th>DATE</th><th>HOURS</th><th>TIPE</th><th>ACCIONES</th></tr>";
        ...
        echo"<a href='admin.php'><br><i class='fa-solid fa-angles-left fa-lg' style='color: #005eff;'></i></button><br></a>";
